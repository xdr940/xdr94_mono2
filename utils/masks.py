...
def IdenticalMask(map_12,map_34):
    #identity_selection = (idxs_0 >= 2).float()  #
    identity_selection = 1-(1.2*map_12<map_34).float()
    need = identity_selection.sum(dim=1).sum(dim=1) < (0.3 * 192 * 640)  # b#如果白色部分小于30%， 说明摄像机静止， 此时取反或者全白
