    ...
    def __init__(self):
        ...
        self.parser.add_argument("--split",
                                 ...
                                 choices=["eigen_zhou",
                                          ...
                                          "mc", "mc_lite",'visdrone','visdrone_lite','custom_mono'],
                                 #default="custom_lite"
                                 #default="mc"
                                 default="custom_mono"
                                 )
        ...
        self.parser.add_argument("--log_dir",
                                 ...
                                 default='/home/roit/models/monodepth2/custom_mono'
        ...
        self.parser.add_argument("--dataset",
                                 ...
                                 #default="visdrone",
                                 default='custom_mono',
                                 choices=["kitti", "kitti_odom", "kitti_depth", "mc",'visdrone','custom_mono'])
...
class run_infer_from_txt:
    def __init__(self):
       ...
       #-------------------------------
        self.parser.add_argument('--out_path', type=str, default='./monodepth2_pred_0006',
        ...
        self.parser.add_argument('--model_path', type=str,
                                 ...
                                 default='/home/roit/models/monodepth2/custom_mono/07082124/models',
        ...
        #----------------------
        self.parser.add_argument('--txt_files',default='test_files.txt')
