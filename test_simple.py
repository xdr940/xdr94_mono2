...
def parse_args():
    ...
    parser.add_argument('--image_path', type=str,default='/home/roit/datasets/VisDrone_prep_input256512/uav0000023_00870_s/',help='path to a test image or folder of images')
